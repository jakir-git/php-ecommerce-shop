...
if(isset($_POST['add_category_btn'])){
    ...
    $update_query = "UPDATE products SET category_id='$category_id', name='$name', slug='$slug', small_desc='$small_desc', description='$desc', original_price='$original_price', selling_price='$selling_price', qty='$qty', meta_title='$meta_title', meta_desc='$meta_desc', meta_keywords='$meta_keywords',status='$status', trending='$popular', image='$update_file_name' WHERE id='$product_id'";
    ...
    if($update_query_run){
        ...
        redirect_with_message('edit-product.php?id='.$product_id, 'Product update successfully');
    }else{
        redirect_with_message('edit-product.php?id='.$product_id, 'Something went wrong!');
    }
}